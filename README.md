...
Realizamos una investigacion en la pagina de los datos del ENACOM y procedimos a descargar los datos de la pagina, mediante pandas convertimos nuestros datos en un formato legible para POWER BI ademas de encontrar datos de interes para nuestro analisis.
mediante el EDA pudimos encontrar los siguientes KPIs:
- Cantidad de usuarios de internet por provincia
- Cantidad de usuarios de internet por tipo de tecnologia
- Cantidad de ingresos a nivel pais
- Promedio de velocidad de bajada a nivel pais
